...
class neptune_flickr extends WP_Widget {
	
	function neptune_flickr() {
		...
		// register the widget
		$this->WP_Widget('neptune_flickr', __('Flickr'), $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
             if ( $title )
				...
				<ul class="neptune-flickr-widget">
...
add_action('widgets_init', create_function('', 'return register_widget("neptune_flickr");'));	
?>