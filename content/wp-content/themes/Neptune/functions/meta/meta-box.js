jQuery(document).ready(function($) {
	...
	// colorpicker field
	$('.neptune-color-picker').each(function(){
		var $this = $(this),
			id = $this.attr('rel');

		$this.farbtastic('#' + id);
	});
	$('.neptune-color-select').click(function(){
		$parent = $(this).parent();
		$(this).siblings('.neptune-color-picker').toggle();
		$('.neptune-color-select', $parent).toggle();
		return false;
	});

	// add more file
	$('.neptune-add-file').click(function(){
	...
	// delete file
	$('.neptune-upload').delegate('.neptune-delete-file', 'click' , function(){
		var $this = $(this),
			$parent = $this.parent(),
			data = $this.attr('rel');
	...
	$('.neptune-images').each(function(){
		...
		$this.sortable({
			...
			update: function (){
				...
				data = order + '|' + $this.siblings('.neptune-images-data').val();
	...
	// thickbox upload
	$('.neptune-upload-button').click(function(){
	...
	// thickbox upload
    window.formfield = '';
    $('.neptune-upload-single-image').live('click', function() {
        window.formfield = $('.neptune-single-image',$(this).parent());
