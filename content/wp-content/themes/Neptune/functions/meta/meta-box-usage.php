...
$neptune_meta_boxes = array();

// meta box ===> Slides
$neptune_meta_boxes[] = array(
	'id' => 'slides_meta',
	'title' => __('Slide Options','neptune'),
	'pages' => array('slides'),

	'fields' => array(
			array(
            'name' => __('Slide Description','neptune'),
            'desc' => __('Enter a description for your slider (optiona). Use h2 tag for a nice title.','neptune'),
            'id' => $prefix . 'slides_description',
            'type' => 'textarea',
            'std' => ''
        ),
		array(
            'name' => __('Slide URL','neptune'),
            'desc' => __('Enter a URL to link this slide to - perfect for linking slides to pages on your site or other sites. Optional.','neptune'),
...
// DO NOT DELETE BELOW
foreach ($neptune_meta_boxes as $meta_box) {
	new neptune_meta_box($meta_box);
}
?>